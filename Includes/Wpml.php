...
class Wpml
{
    public function __construct()
    {
        ...
        add_action('wp_nav_menu_thin-dutch_items', [$this, 'languageSwitcherInMenu'], 20, 2);
        add_action('wp_nav_menu_mobile-menu_items', [$this, 'languageSwitcherInMenu'], 20, 2);
        add_action('wp_nav_menu_mobile-menu-dutch_items', [$this, 'languageSwitcherInMenu'], 20, 2);
    }
